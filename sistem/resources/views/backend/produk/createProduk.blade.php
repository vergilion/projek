...
@section('content')
	...
	<section role="main" class="content-body">
		<header class="page-header">
			<h2><a href="{{route('produk')}}">Master Produk</a> | Create</h2> 
				...
				<div class="col-xs-12">
					<section class="panel form-wizard" id="w4">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" novalidate="novalidate" method="post" action="{{ route('produk.store') }}" enctype="multipart/form-data">
								{{csrf_field()}}
									...
									<div id="w4-info" class="tab-pane active">
										*Kolom Harus Diisi
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="kode" id="kode" required minlength="5">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea name="deskripsi" class="form-control" rows="7" required></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="harga">Harga*</label>
											<div class="col-sm-6">
												<input type="number" class="form-control" name="harga" id="harga" required min="100">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="stok">Stok*</label>
											<div class="col-sm-6">
												<input type="number" class="form-control" name="stok" id="stok" required min="1">
											</div>
										</div>
									</div>
