...
@section('content')
	...
	<!-- Specific Page Vendor -->
		<script src="{{ asset('backend/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js') }}"></script>
		<script src="{{ asset('backend/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js') }}"></script>
		...
		<script src="{{ asset('backend/vendor/jquery-easypiechart/jquery.easypiechart.js') }}"></script>
	...
	<!-- Examples -->
		<script src="{{ asset('backend/javascripts/dashboard/examples.dashboard.js') }}"></script>
@endsection